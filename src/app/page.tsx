  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-green-600 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            <h1 className={`text-4xl font-bold mb-4 ${styles.text_green}`}>Welcome</h1>
            ...
            <a href="/blog/posts" className={`text-green-500 outline outline-1 outline-offset-2 border-green-700 text-green-700 hover:text-white py-2 px-4 rounded hover:bg-green-800 md:w-auto ${styles.fit_content}`}>
              Go to Blog
            </a>
          </div>
